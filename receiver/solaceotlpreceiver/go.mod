module github.com/ThinkportRepo/opentelemetry-solace-otlp/receiver/solaceotlpreceiver
...
replace github.com/ThinkportRepo/opentelemetry-solace-otlp/receiver/solaceotlpreceiver => .
